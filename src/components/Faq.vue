      ...
      faqItems: [
        {
          ...
          value: 'Yes. The font is [released under the SIL Open Font License](https://github.com/rubjo/victor-mono/blob/master/LICENSE). If you\'d like to say thanks, you can <a href="https://paypal.me/runbjo" class="donate" target="_blank">donate</a>. I\'d also appreciate it if you referred others to this web site rather than serving the font files from elsewhere.',
          category: 'Usage'
        }, {
